...
All modules are now fully resizable, allowing users to create a custom workspace layout.
The Spectrum module now uses a Blackman-Harris FFT window for improved definition.

Resulting in

Higher frequency resolution
Smoother spectral ballistics
...
Insert the original plugins on any track.

Copy and paste each modified code from this repository over the original. Must overwrite all 3 codes (1 jsfx and 2 actions) per plugin.

Save. The modified behavior will be applied immediately.

Done. Have Fun :)

Video for Instructions: https://youtu.be/5OI7sSmfvco

# License

Please respect the licenses and credit the original authors when redistributing or modifying these scripts.
